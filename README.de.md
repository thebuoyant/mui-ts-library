...
- **CI — Codecov Coverage-Reporting**: Coverage wird bei jedem CI-Lauf gemessen und auf [Codecov](https://codecov.io/gh/thebuoyant/mui-ts-library) veröffentlicht. Coverage-Badge in der README ergänzt.
