...
| ~~⭐ Filter / Suche~~ | ~~`filterText?: string` als controlled Prop filtert sichtbare Karten nach Titel und Assignee — die Spalten-Zähler passen sich an. Consumer rendert das Suchfeld selbst und übergibt den String. Standard bei jeder Board-Implementierung sobald 20+ Karten vorhanden sind.~~ | Mittel | ✅ v3.33.0 |
