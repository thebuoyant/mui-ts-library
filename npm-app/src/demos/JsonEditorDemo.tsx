...
import { JSON_EDITOR_SAMPLE_VALUE } from "../fixtures/jsonEditorFixture";
...
const CONTROLS: ControlDef[] = [
  ...
  { key: "indent", label: "indent", type: "number", min: 0, max: 8, step: 1 },
  ...
  { key: "showMinimap", label: "showMinimap", type: "boolean" },
  { key: "showValidation", label: "showValidation", type: "boolean" },
...
export function JsonEditorDemo() {
  ...
  const [editorValue, setEditorValue] = useState<string>(JSON_EDITOR_SAMPLE_VALUE);
    ...
    <DemoLayout
      preview={
        <JsonEditor
          ...
          showMinimap={values.showMinimap as boolean}
          showValidation={values.showValidation as boolean}
